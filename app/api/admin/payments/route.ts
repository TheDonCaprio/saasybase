  ...
  try {
    ...
    if (search) {
      where.OR = [
        ...
        { stripeRefundId: buildStringContainsFilter(search, dbUrl) },
    ...
    const mappedPayments = payments.map((p) => {
      ...
      return {
        ...
        externalPaymentId: typeof rec.externalPaymentId === 'string' ? rec.externalPaymentId : (typeof rec.stripePaymentIntentId === 'string' ? rec.stripePaymentIntentId : null),
        externalSessionId: typeof rec.externalSessionId === 'string' ? rec.externalSessionId : (typeof rec.stripeCheckoutSessionId === 'string' ? rec.stripeCheckoutSessionId : null),
        ...
        dashboardUrl: typeof rec.externalPaymentId === 'string'
          ...
          : (typeof rec.stripePaymentIntentId === 'string' ? paymentService.getDashboardUrl('payment', rec.stripePaymentIntentId) : null),
        ...
        user: {
          ...
          externalCustomerId: typeof userRec.externalCustomerId === 'string' ? userRec.externalCustomerId : (typeof userRec.stripeCustomerId === 'string' ? userRec.stripeCustomerId : null),
        ...
        subscription: subRec ? {
          ...
          externalSubscriptionId: typeof subRec.externalSubscriptionId === 'string' ? subRec.externalSubscriptionId : (typeof subRec.stripeSubscriptionId === 'string' ? subRec.stripeSubscriptionId : null),
          ...
          plan: planRec ? {
            ...
            stripePriceId: typeof planRec.stripePriceId === 'string' ? planRec.stripePriceId : null,
