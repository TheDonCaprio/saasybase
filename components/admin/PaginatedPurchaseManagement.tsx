          ...
          <>
            ...
            <div className="md:hidden space-y-3 p-3 sm:p-4">
              {purchases.map((purchase) => {
                ...
                return (
                  <div key={purchase.id} className={dashboardMutedPanelClass('space-y-3 p-3 sm:p-4')}>
                    ...
                    {pricing.hasDiscount || purchase.couponCode ? (
              ...
              <div className="divide-y divide-slate-100/80 dark:divide-neutral-800/80">
                {purchases.map((purchase) => {
                  ...
                  return (
                    <div
                      key={purchase.id}
                      className="grid grid-cols-[1.5fr_1.5fr_1fr_1fr_1fr_0.5fr_1.25fr_0.75fr] items-center gap-3 px-4 py-3 text-sm text-slate-600 transition-colors hover:bg-slate-50/70 dark:text-neutral-300 dark:hover:bg-neutral-900/60"
                    >
