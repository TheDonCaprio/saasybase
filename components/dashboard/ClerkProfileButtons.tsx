...
function NextAuthProfileEditor({
  ...
  const passwordToggleButtonClass = 'absolute inset-y-0 right-0 flex items-center px-3 text-slate-400 transition hover:text-slate-600 dark:text-neutral-500 dark:hover:text-neutral-300';
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 pr-11 text-sm text-slate-900 shadow-sm focus:border-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-200 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
              />
              <button
                type="button"
              ...
              >
                {showCurrentPassword ? (
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.98 8.223A10.477 10.477 0 002.8 12c1.736 4.816 6.242 8 11.2 8 1.16 0 2.287-.189 3.351-.54M8.94 8.94A3 3 0 1115.06 15.06M3 3l18 18M9.88 9.88A3 3 0 0114.12 14.12" />
                  </svg>
                ) : (
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.25 12.0001C3.554 7.044 7.893 3.5 13 3.5c5.107 0 9.446 3.544 10.75 8.5-1.304 4.956-5.643 8.5-10.75 8.5-5.107 0-9.446-3.544-10.75-8.5Z" />
