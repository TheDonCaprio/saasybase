...
export const SETTING_KEYS = {
  ...
  THEME_DEFAULT_MIGRATION_VERSION: 'THEME_DEFAULT_MIGRATION_VERSION',
  ...
  ,SEO_HOME_META_TITLE: 'SEO_HOME_META_TITLE'
  ,SEO_HOME_META_DESCRIPTION: 'SEO_HOME_META_DESCRIPTION'
  ,SEO_NOINDEX_SITE: 'SEO_NOINDEX_SITE'
  ,SEO_TITLE_SUFFIX: 'SEO_TITLE_SUFFIX'
  ,SEO_TITLE_TEMPLATE: 'SEO_TITLE_TEMPLATE'
  ,SEO_HOME_OG_TITLE: 'SEO_HOME_OG_TITLE'
  ,SEO_HOME_OG_DESCRIPTION: 'SEO_HOME_OG_DESCRIPTION'
  ,SEO_HOME_OG_IMAGE: 'SEO_HOME_OG_IMAGE'
  ,SEO_DEFAULT_OG_TITLE: 'SEO_DEFAULT_OG_TITLE'
  ,SEO_DEFAULT_OG_DESCRIPTION: 'SEO_DEFAULT_OG_DESCRIPTION'
  ,SEO_DEFAULT_OG_IMAGE: 'SEO_DEFAULT_OG_IMAGE'
  ,SEO_HOME_CANONICAL_URL: 'SEO_HOME_CANONICAL_URL'
  ,SEO_BLOG_META_TITLE: 'SEO_BLOG_META_TITLE'
  ,SEO_BLOG_META_DESCRIPTION: 'SEO_BLOG_META_DESCRIPTION'
  ,SEO_NOINDEX_BLOG_INDEX: 'SEO_NOINDEX_BLOG_INDEX'
  ,SEO_NOINDEX_BLOG_CATEGORY_PAGES: 'SEO_NOINDEX_BLOG_CATEGORY_PAGES'
  ,SEO_SITEMAP_CUSTOM_URLS: 'SEO_SITEMAP_CUSTOM_URLS'
  ,SEO_SITEMAP_EXCLUDED_URLS: 'SEO_SITEMAP_EXCLUDED_URLS'
  ,SEO_GOOGLE_SITE_VERIFICATION: 'SEO_GOOGLE_SITE_VERIFICATION'
  ,SEO_BING_SITE_VERIFICATION: 'SEO_BING_SITE_VERIFICATION'
  ,SEO_ROBOTS_TXT_CUSTOM: 'SEO_ROBOTS_TXT_CUSTOM'
} as const;
...
export const FLOW_THEME_COLOR_PALETTE: ThemeColorPalette = {
  light: {
    bgPrimary: '#ffffff',
    bgSecondary: '#f9fafb',
    panelBg: '#f9fafb',
...
export const SETTING_DEFAULTS = {
  ...
  [SETTING_KEYS.THEME_COLOR_PRESETS]: '[]',
  [SETTING_KEYS.THEME_DEFAULT_MIGRATION_VERSION]: '',
  ...
  ,[SETTING_KEYS.SEO_HOME_META_TITLE]: ''
  ,[SETTING_KEYS.SEO_HOME_META_DESCRIPTION]: ''
  ,[SETTING_KEYS.SEO_NOINDEX_SITE]: 'false'
  ,[SETTING_KEYS.SEO_TITLE_SUFFIX]: ''
  ,[SETTING_KEYS.SEO_TITLE_TEMPLATE]: ''
  ,[SETTING_KEYS.SEO_HOME_OG_TITLE]: ''
  ,[SETTING_KEYS.SEO_HOME_OG_DESCRIPTION]: ''
  ,[SETTING_KEYS.SEO_HOME_OG_IMAGE]: ''
  ,[SETTING_KEYS.SEO_DEFAULT_OG_TITLE]: ''
  ,[SETTING_KEYS.SEO_DEFAULT_OG_DESCRIPTION]: ''
  ,[SETTING_KEYS.SEO_DEFAULT_OG_IMAGE]: ''
  ,[SETTING_KEYS.SEO_HOME_CANONICAL_URL]: ''
  ,[SETTING_KEYS.SEO_BLOG_META_TITLE]: ''
  ,[SETTING_KEYS.SEO_BLOG_META_DESCRIPTION]: ''
  ,[SETTING_KEYS.SEO_NOINDEX_BLOG_INDEX]: 'false'
  ,[SETTING_KEYS.SEO_NOINDEX_BLOG_CATEGORY_PAGES]: 'true'
  ,[SETTING_KEYS.SEO_SITEMAP_CUSTOM_URLS]: '[]'
  ,[SETTING_KEYS.SEO_SITEMAP_EXCLUDED_URLS]: '[]'
  ,[SETTING_KEYS.SEO_GOOGLE_SITE_VERIFICATION]: ''
  ,[SETTING_KEYS.SEO_BING_SITE_VERIFICATION]: ''
  ,[SETTING_KEYS.SEO_ROBOTS_TXT_CUSTOM]: ''
} as const;
...
export async function getThemeColorPalette(): Promise<ThemeColorPalette> {
  ...
  const paletteSettingExists = await safeFindSettingKey(SETTING_KEYS.THEME_COLOR_PALETTE);
  if (!paletteSettingExists) {
    return DEFAULT_THEME_COLOR_PALETTE;
  }

  const migrationMarker = await getSetting(
    SETTING_KEYS.THEME_DEFAULT_MIGRATION_VERSION,
    SETTING_DEFAULTS[SETTING_KEYS.THEME_DEFAULT_MIGRATION_VERSION],
  );
  ...
  try {
    ...
    if (migrationMarker !== THEME_DEFAULT_MIGRATION_VERSION) {
      const legacyPalette = {
        light: mergeThemeColorTokens(rec.light, FLOW_THEME_COLOR_PALETTE.light),
        dark: mergeThemeColorTokens(rec.dark, FLOW_THEME_COLOR_PALETTE.dark),
      };

      if (themePalettesEqual(legacyPalette, FLOW_THEME_COLOR_PALETTE)) {
        await Promise.all([
          setSetting(SETTING_KEYS.THEME_COLOR_PALETTE, JSON.stringify(DEFAULT_THEME_COLOR_PALETTE)),
          setSetting(SETTING_KEYS.THEME_DEFAULT_MIGRATION_VERSION, THEME_DEFAULT_MIGRATION_VERSION),
        ]);
        return DEFAULT_THEME_COLOR_PALETTE;
      }

      await setSetting(SETTING_KEYS.THEME_DEFAULT_MIGRATION_VERSION, THEME_DEFAULT_MIGRATION_VERSION);
    }
