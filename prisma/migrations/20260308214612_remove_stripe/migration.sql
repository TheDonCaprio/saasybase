-- Normalize SQLite unique indexes after legacy Stripe column removal.
-- SQLite turns inline UNIQUE constraints into autoindexes; this migration rebuilds
-- the affected tables so Prisma sees the named unique indexes defined by the schema.
